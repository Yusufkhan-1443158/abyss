...
def bottom_type_clusters(
    ...
    try:
        ...
        # n_init defaults to 10 (unchanged). Lower via env on very large scenes
        # to cut the k-means cost (fewer restarts) at a small stability cost.
        n_init = max(1, int(os.getenv("DL_PRO_KMEANS_NINIT", "10")))
