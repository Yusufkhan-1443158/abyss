...
(function () {
  ...
  const DOCK_ITEMS = [
    ...
    ['bathymetry-studio', 'Studio', 'pin', 'bathymetry-studio.html'],
  ...
  function injectTopbar() {
    ...
    topbar.innerHTML = `
      ...
      <div class="glyph-topbar-right">
        <button class="glyph-lang-toggle" id="glyph-lang-toggle" title="عربي / English">${localStorage.getItem('glyph_lang') === 'ar' ? 'EN' : 'ع'}</button>
  ...
  // ======================== INIT ========================
  function init() {
    // Add body class for base styling
